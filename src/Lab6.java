...
public class Lab6{
    public static void main(String[] args) {
        ...
        do { //create do while method to run code once before condition while
            ...
            sentenceEntered = sentenceInput.split(" "); //
            ...
            for (String englishSentence : sentenceEntered) { 	//create an enhanced For Loop, aka, "for each" loop - 
            													...
            													//for (dataTypeOfElement tempVarName: nameOfArray
            													//for each iteration englishSentence will hold 
        ...
        System.out.println();
        } while(!sentenceInput.equals("quit"));
